  ...
  var a = (function b (c, d, e) {
  ...
  })(
    {
        ...
        function (a, b, c) {
          ...
          ;(f.Sender = e.extend({
            ...
            (f.Segment = f.Sender.extend({
              ...
              send: function (a, b, c) {
                window.analytics.track('Embedly > ' + a + ' > ' + b, { url: c })
              }
            })),
      ...
      21: [
        ...
        { './comms.js': 6, './urlparse.js': 28, './utils.js': 29, conf: 'conf' }
      ],
      22: [
        function (a, b, c) {
          function d (a) {
        ...
        function (a, b, c) {
          ...
          ;(g.prototype.init = function () {
            ...
            (g.prototype.ready = function () {
              return this.isReady
                ? !1
                : ((this.isReady = !1), void (this.callback && this.callback()))
            }),
          ...
          ;(e.identity = function (a) {
            ...
            (e.reduce = function (a, b, c, d) {
              ...
              if ((null == a && (a = []), m && a.reduce === m))
                return d && (b = e.bind(b, d)), f ? a.reduce(b, c) : a.reduce(b)
              if (
